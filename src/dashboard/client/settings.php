...
<div class="sidebar" id="sidebar">
  ...
  <ul class="nav flex-column mt-4">
    <li class="nav-item">
      <a class="nav-link" href="../client.php"><i class="bi bi-speedometer2"></i> Dashboard</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="orders.php.php"><i class="bi bi-receipt"></i> Meus Pedidos</a>
    </li>
    <li class="nav-item">
      <a class="nav-link active" href="#"><i class="bi bi-gear"></i> Configurações</a>
    </li>
